...
<div class="row">
    <div class="col-md-4 mb-4 stretch-card transparent">
        <div class="card card-tale">
            <div class="card-body">
                <p class="mb-4">Total Housekeeping Item</p>
                <p class="fs-30 mb-2">{{$countitem}}</p>
            </div>
        </div>
    </div>
</div>
                        ...
                        <div class="row">
                          <div class="col-md-12 col-xl-3 d-flex flex-column justify-content-start">
                            <div class="ml-xl-4 mt-3">
                              ...
                              <h1 class="text-primary">{{$countitem}}</h1>
                                ...
                                <div class="table-responsive mb-3 mb-md-0 mt-3">
                                  ...
                                  @foreach($stockitem as $s)
                                    <tr>
                                      ...
                                      <td><h5 class="font-weight-bold mb-0">{{$s->currentstock}}</h5></td>
                                    </tr>
                                    @endforeach
                                  </table>
                                </div>
